...
public class Strings {
	...
	private static final String
		FRAME_TITLE = "Integer Graph Generator",
		ABOUT_DIALOG_TITLE = "About",
		ABOUT_TITLE = "Integer Graph Generator",
		ABOUT_TEXT = "Create and edit your charts and graphs.\n"
				+ "Autor: Svetlin Burgov\n"
				+ "e-mail: info@standart.xyz",
		DIALOG_TITLE = "Create New Graph",
		DIALOG_EDIT_GRAPH_TITLE = "Edit Graph",
		DIALOG_IMPORT_GRAPH_TITLE = "Import Graph",
		ATTR_GRAPH_TITLE = "Graph Title",
		ATTR_X_TEXT = "Axis X Title",
		ATTR_Y_TEXT = "Axis Y Title",
		NUMBER_NODES_TEXT = "Number of Peeks",
		CHART_TYPE = "Chart Type",
		COLOR_CHOOSER_TITLE = "Choose Graph Color",
		...
		EXPORT_GRAPH_TXT_TITLE = "Export graph data as TXT",
		EXPORT_GRAPH_PDF_TITLE = "Export graph as PDF",
		FILE_TYPE_TXT = ".txt",
		FILE_TYPE_PDF = ".pdf",
		NEW_LINE = "\n",
		CSS = "<span style = \"color: black; font-weight: bold;\">",
		ERROR_MESSAGE_ATTR = "No values entered for Graph or Axis title(s)!",
		...
		NOT_EXPORTED_GRAPH_MESSAGE = "The generated Graph is not exported.\n"
				+ "Continue WITHOUT exporting?",
		EXPORTED_GRAPH_TITLE = "Info",
		EXPORTED_GRAPH_MESSAGE_PDF = "The generated Graph is exported to .pdf file.",
		EXPORTED_GRAPH_MESSAGE_TXT = "The generated Graph data is exported to .txt file",
