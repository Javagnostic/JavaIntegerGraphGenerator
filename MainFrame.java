...
public class MainFrame extends JFrame{
	...
	public MainFrame (){
		...
		this.createGraph = new JMenuItem("Create Graph");
		editGraph = new JMenuItem("Edit Graph");
		importGraphData = new JMenuItem("Import Graph Data");
		exportMenu = new JMenu("Export Graph As");
			exportGraphAsPDF = new JMenuItem("PDF");
			exportGraphAsTXT = new JMenuItem("TXT Data");
		this.exitApp = new JMenuItem("Exit");
		
		//View Menu
		this.viewMenu = new JMenu("View");
		peeksValues = new JCheckBoxMenuItem("Peeks Values", true);
